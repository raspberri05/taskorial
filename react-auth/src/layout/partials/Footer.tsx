...
function Footer() {
  /**
   * Function to display legal links in footer of app
   * @returns JSX Element containing legal links
   */
  const legalLinks = () => (
  ...
  /**
   * Function to display community links in footer of app
   * @returns JSX Element containing community links
  */
  ...
  /**
   * Function to display contact links in footer of app
   * @returns JSX Element containing contact links
   */
  const contactLinks = () => (
    <div className="col-6 col-lg-2 mb-3">
