    ...
    <>
      ...
      <Container>
        ...
        <p>
          ...
          reformat, display and perform the Content of your user account solely
          as required for the purpose of providing the Services to you. Unless
          specifically permitted by you, your use of the Website and Services
          ...
          user account for commercial, marketing or any similar purpose.
        </p>
        ...
        <p>
          ...
          you any intellectual property owned by the Operator or third parties,
          and all rights, titles, and interests in and to such property will
          remain (as between the parties) solely with the Operator. All
          ...
          the Operator or its licensors. Other trademarks, service marks,
        ...
        <p>
          ...
          relating to your Content, your use of the Website and Services or any
        ...
        <p>
          ...
          use the Website and Services. This policy has been created with the
          help of the{" "}
          <a
