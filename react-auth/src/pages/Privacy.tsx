    ...
    <Container>
      ...
      <ul>
        ...
        <li><strong>Company</strong> (referred to as either &quot;the
            ...
            this Agreement) refers to Taskorial.
        </li><br/>
        <li><strong>Cookies</strong> are small files that are placed on Your
            computer, mobile device or any other device by a website, containing
            the details of Your browsing history on that website among its many
            uses.
        </li><br/>
        <li><strong>Country</strong> refers to: California, United States
        </li><br/>
        <li><strong>Device</strong> means any device that can access the Service
        ...
        <li><strong>Service Provider</strong> means any natural or legal person
        ...
        <li><strong>Usage Data</strong> refers to data collected automatically,
      ...
      <ul>
        <li><strong>Cookies or Browser Cookies.</strong> A cookie is a small file
        ...
        <li><strong>Web Beacons.</strong> Certain sections of our Service and our
      ...
      <ul>
        ...
        <li><strong>To manage Your Account:</strong> to manage Your registration
        ...
        <li><strong>For the performance of a contract:</strong> the development,
            ...
            contract with Us through the Service.</li><br/>
        ...
        <li><strong>For business transfers:</strong> We may use Your information
